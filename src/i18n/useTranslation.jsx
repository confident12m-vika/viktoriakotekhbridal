...
// hook للترجمة — يجيب من Context عشان كل الصفحة تتحدث تلقائياً
          ...
          {LANGS.map(l => (
            <button key={l.code} onClick={() => { setLang(l.code); setOpen(false); }}
              style={{
                ...
                fontFamily: "'Jost', sans-serif", transition: '0.2s',
              }}>
              {l.label}
            </button>
          ))}
...
// نسخة الموبايل — جوه القائمة الجانبية
